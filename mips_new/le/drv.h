...
char *getData(u_long *sizep);
int startWork(u_int32_t start, u_int32_t end);
int start_module_trace(u_int32_t start, u_int32_t end);
...
//int getU64(struct slice *b, u_int32_t *x);
